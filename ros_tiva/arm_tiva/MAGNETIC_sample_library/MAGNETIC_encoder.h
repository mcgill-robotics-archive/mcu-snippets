...
#ifndef MAGNETIC_ABS_ENCODER_H
#define MAGNETIC_ABS_ENCODER_H

typedef struct {
	uint32_t 
} MAGNETIC_abs_encoder;

extern void MAG_encoder_init(MAG_abs_encoder mag);
...
//ignore the following for now. copy pasted for reference from cdr stuff
