...
void main(void) {
	...
	// Set up the InA pin as D0, and InB as pin D1
	//Can also write as:
     ...
     *
     * If we want a frequency of 250Hz:
     ...
     */
    //From PWM peripheral base 1 to peripheral pin 3 (configured as pwm)
    //with period as 40000 clock ticks
    ...
    // Duty-cycle of the PWM set as half the period of the period of the PWM signal.
    ...
    // Pin InA set to high and InB set to low
